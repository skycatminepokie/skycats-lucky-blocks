...
public class LuckyEffects {
    // TODO: Testing
    public static final SimpleLuckyEffect SAY_HI = new SimpleLuckyEffect(Identifier.of(MOD_ID, "say_hi"), (world, pos, state, player) -> player.sendMessage(Text.of("[Lucky Block] Hi")));
}
